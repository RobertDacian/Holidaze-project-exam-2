...
//   await sendRequest(API_AUTH_REGISTER, 'POST', body);
...
//   await sendRequest(API_AUTH_VENUE_MANAGER_REGISTER, 'POST', body);
...
// export const login = async (email, password, isVenueManager) => {
